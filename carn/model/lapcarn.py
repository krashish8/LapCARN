...
class LapCARN(nn.Module):
    def __init__(self):
        ...
        self.upsample_3 = ops.UpsampleBlock(3, group=1)
        self.upsample_64 = ops.UpsampleBlock(64, group=1)
        self.feat = self.make_layer(carn.Net)
